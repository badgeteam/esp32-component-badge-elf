...
extern char const symbol_pax_font_saira_condensed_raw[] asm("pax_font_saira_condensed_raw");
extern char const symbol_pax_font_saira_regular_raw[] asm("pax_font_saira_regular_raw");
...
extern char const symbol_pax_buf_get_width_raw[] asm("pax_buf_get_width_raw");
extern char const symbol_pax_buf_get_height_raw[] asm("pax_buf_get_height_raw");
extern char const symbol_pax_buf_get_dims_raw[] asm("pax_buf_get_dims_raw");
...
extern char const symbol_matrix_2d_transform_alt[] asm("matrix_2d_transform_alt");
extern char const symbol_pax_recti_abs[] asm("pax_recti_abs");
extern char const symbol_pax_rectf_abs[] asm("pax_rectf_abs");
extern char const symbol_pax_recti_intersect[] asm("pax_recti_intersect");
extern char const symbol_pax_rectf_intersect[] asm("pax_rectf_intersect");
extern char const symbol_pax_vec2f_unify[] asm("pax_vec2f_unify");
extern char const symbol_pax_orient_det_vec2f[] asm("pax_orient_det_vec2f");
extern char const symbol_pax_unorient_det_vec2f[] asm("pax_unorient_det_vec2f");
extern char const symbol_pax_orient_det_rectf[] asm("pax_orient_det_rectf");
extern char const symbol_pax_unorient_det_rectf[] asm("pax_unorient_det_rectf");
extern char const symbol_pax_orient_det_vec2i[] asm("pax_orient_det_vec2i");
extern char const symbol_pax_unorient_det_vec2i[] asm("pax_unorient_det_vec2i");
extern char const symbol_pax_orient_det_recti[] asm("pax_orient_det_recti");
extern char const symbol_pax_unorient_det_recti[] asm("pax_unorient_det_recti");
...
extern char const symbol_pax_utf8_getch_l[] asm("pax_utf8_getch_l");
extern char const symbol_pax_utf8_strlen_l[] asm("pax_utf8_strlen_l");
extern char const symbol_pax_utf8_seeknext_l[] asm("pax_utf8_seeknext_l");
extern char const symbol_pax_utf8_seekprev_l[] asm("pax_utf8_seekprev_l");
extern char const symbol_pax_load_font[] asm("pax_load_font");
extern char const symbol_pax_store_font[] asm("pax_store_font");
extern char const symbol_pax_draw_text_adv[] asm("pax_draw_text_adv");
extern char const symbol_pax_text_size_adv[] asm("pax_text_size_adv");
